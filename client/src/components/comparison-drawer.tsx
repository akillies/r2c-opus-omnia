...
interface ComparisonDrawerProps {
  ...
  onSelectAlternative?: (swapId: string, alternativeProductId: string) => void;
}

export default function ComparisonDrawer({ isOpen, onClose, swap, onAcceptSwap, onSelectAlternative }: ComparisonDrawerProps) {
                  ...
                  >
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      {onSelectAlternative && (
                        <Button
                          onClick={() => {
                            onSelectAlternative(swap.id, alt.id);
                            onClose();
                          }}
                          variant="outline"
                          size="sm"
                          className="text-xs border-blue-300 text-blue-700 hover:bg-blue-50 shrink-0 ml-2"
                          data-testid={`button-select-alt-${index}`}
                        >
                          Choose This
                        </Button>
                      )}
